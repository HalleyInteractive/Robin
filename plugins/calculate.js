...
function plus(cmd)
{
	...
	case "en-US":
	default:
		global.robin.mouth.say("The sum of " + cmd[1] + " plus " + cmd[2] + " is " + (parseFloat(cmd[1]) + parseFloat(cmd[2])).toFixed(2));
	break;
	case "nl-NL":
		global.robin.mouth.say("The uitkomst van " + cmd[1] + " plus " + cmd[2] + " is " + (parseFloat(cmd[1]) * parseFloat(cmd[2])).toFixed(2));
	break;
	}
}
...
function minus(cmd)
{
	...
	case "en-US":
	default:
		global.robin.mouth.say("The sum of " + cmd[1] + " minus " + cmd[2] + " is " + (parseFloat(cmd[1]) - parseFloat(cmd[2])).toFixed(2));
	break;
	case "nl-NL":
		global.robin.mouth.say("The uitkomst van " + cmd[1] + " min " + cmd[2] + " is " + (parseFloat(cmd[1]) * parseFloat(cmd[2])).toFixed(2));
	break;
	}
}
...
function divided(cmd)
{
	...
	case "en-US":
	default:
		global.robin.mouth.say("The sum of " + cmd[1] + " divided by " + cmd[2] + " is " + (parseFloat(cmd[1]) / parseFloat(cmd[2])).toFixed(2));
	break;
	case "nl-NL":
		global.robin.mouth.say("The uitkomst van " + cmd[1] + " gedeeld door " + cmd[2] + " is " + (parseFloat(cmd[1]) * parseFloat(cmd[2])).toFixed(2));
	break;
	}
}
...
function times(cmd)
{
	...
	case "en-US":
	default:
		global.robin.mouth.say("The sum of " + cmd[1] + " times " + cmd[2] + " is " + (parseFloat(cmd[1]) * parseFloat(cmd[2])).toFixed(2));
	break;
	case "nl-NL":
		global.robin.mouth.say("The uitkomst van " + cmd[1] + " keer " + cmd[2] + " is " + (parseFloat(cmd[1]) * parseFloat(cmd[2])).toFixed(2));
	break;
	}
