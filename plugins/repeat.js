...
function repeat()
{
	...
	if(global.robin.settings.lastCommand.command !== null && global.robin.settings.lastCommand.command !== undefined)
	{
		global.robin.settings.lastCommand.callback(global.robin.settings.lastCommand.command);
	}
}
